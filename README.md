...
This plugin is already installed on our own Galaxy server, [GIO](http://gio.sbcs.qmul.ac.uk). Scroll down to the "How to use ProViewer plugin" section below to find out how to use it.
