...
mzid <- read.csv(file="/Users/sureshhewapathirana/Documents/Projects/ResearchProject/mzIdentMLVisualiser/test/mzIdentML_12_08_2016.csv", header=TRUE, sep=",")
...
mean(mzid$Size.Bytes./1000000)
median(mzid$Size.Bytes./1000000)
min(mzid$Size.Bytes./1000000)
max(mzid$Size.Bytes./1000000)

# largets  and smallest file size records
mzid[which((mzid$Size.Bytes. == min(mzid$Size.Bytes.))==TRUE),]
mzid[which((mzid$Size.Bytes. == max(mzid$Size.Bytes.))==TRUE),]
